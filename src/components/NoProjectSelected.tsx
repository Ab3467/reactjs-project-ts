...
const NoProjectSelected : React.FC<ProjectSideBarProps> = ({onStartAddProject}) => {
  return (
    <div className=" mt-44 text-center w-2/3">
        ...
        <Button variant="secondary" size="default" onClick={onStartAddProject}>Create New Project</Button>
    </div>
  )
}
